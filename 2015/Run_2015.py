# Advent of Code - 2015
# Solved in 2024
# Puzzle Link: https://adventofcode.com/2015
# Solution by: [abbasmoosajee07]
# Brief: [Run all 2015 scripts]
...
def create_table(file_info, times_taken, Year, repo_dir):
    ...
    with open(table_path, 'w') as f:
        f.write(f"{'Day':<6}{'Time (s)':<12}{'Percentage':<15}{'Lang':<12}{'Line Count':<12}\n")
        f.write("-" * 60 + "\n")
...
if __name__ == "__main__":
    ...
    problems = range(1, 26)
    main(Challenge, Year, problems, bright_red)