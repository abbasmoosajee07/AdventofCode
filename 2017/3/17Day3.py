...
if shortest_path_length != -1:
    print(f"The shortest path from {input_value} at {start} to 1 \n at {goal} is {shortest_path_length} steps.")
else:
    print(f"No path found from {start} to {goal}.")

# Example usage for Part 2
P2_next_val = find_next_value(input)
print(f"Part 2: THe next value in the grid spiral is: {P2_next_val}")
