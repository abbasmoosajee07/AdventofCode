...
class Intcode_CPU:
    ...
    Methods:
        ...
        edit_program(): Edit the program and memory based on an edit list
        __add_cpu_inputs(cpu_inputs): Add cpu_inputs to existing input queue.
    ...
    def __init__(self, program: list[int], init_inputs = None, pointer: int = 0, debug: bool = False):
        ...
        self.inputs_queue = []
        self.__add_cpu_inputs(init_inputs)
    ...
    def __add_cpu_inputs(self, cpu_inputs):
        """
    ...
    def edit_program(self, edit_list: list[tuple[int, int]]):
        """
        Edit the program and memory based on the provided list of edits, 
        given in the form of a tuple `(pos, value)`
        """
        for pos, val in edit_list:
    ...
    def process_program(self, external_input = None):
        ...
        if external_input is not None:
            self.__add_cpu_inputs(external_input)
